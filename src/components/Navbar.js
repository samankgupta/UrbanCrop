                        ...
                        <div className="relative flex items-center justify-between h-16">
                            ...
                            <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                                <div className="flex-shrink-0 flex items-center">
                                    <Link to="/"><h1 className="text-3xl bg-clip-text text-transparent font-bold bg-gradient-to-r from-green-800 to-green-500">UrbanCrop</h1></Link><br />
                                </div>
                                        ...
                                        {navigation.map((item) => (
                                            <Link
                                                ...
                                                className={classNames(
                                                    item.current ? ' text-black' : 'text-gray-500 hover:text-black',
                        ...
                        <div className="px-2 pt-2 pb-3 space-y-1">
                            {navigation.map((item) => (
                                <a
                                    ...
                                    href={item.href}
                                    className={classNames(
                                        item.current ? 'bg-green-200 text-black' : 'text-gray-800 hover: hover:text-black',
